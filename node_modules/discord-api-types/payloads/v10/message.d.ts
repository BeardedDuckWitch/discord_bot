...
import type { APIInteractionDataResolved, APIMessageInteraction, APIMessageInteractionMetadata, FileUploadType } from './interactions';
 ...
 */
export declare enum BaseThemeType {
    Unset = 0,
    Dark = 1,
    Light = 2,
    Darker = 3,
 ...
 */
export declare enum MessageSearchAuthorType {
    /**
 ...
 */
export declare enum MessageSearchHasType {
    /**
 ...
 */
export declare enum MessageSearchEmbedType {
    /**
 ...
 */
export declare enum MessageSearchSortMode {
    /**
